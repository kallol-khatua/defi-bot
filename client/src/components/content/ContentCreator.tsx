  ...
  const handleGenerate = () => {
    if (!prompt) {
      toast({
        ...
        description: "You need to provide some context for the AI to generate content.",
        variant: "destructive",
      });
      return;
    }
  ...
  return (
    <div className="space-y-6">
      <Tabs defaultValue="create" className="w-full">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="telegram">Telegram Update</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    {renderIcon()}
                    <h3 className="font-medium">Generated {contentType.charAt(0).toUpperCase() + contentType.slice(1)} Content</h3>
                  </div>
        ...
        <TabsContent value="schedule" className="min-h-[300px] flex items-center justify-center">
          <div className="text-center text-gray-500">
            <p className="mb-2">Scheduling feature coming soon</p>
            <p className="text-sm">Automatically schedule your AI-generated content across platforms</p>
          </div>
        </TabsContent>
        
        <TabsContent value="analytics" className="min-h-[300px] flex items-center justify-center">
          <div className="text-center text-gray-500">
            <p className="mb-2">Content analytics coming soon</p>
            <p className="text-sm">Track performance of your AI-generated content</p>
          </div>
        </TabsContent>
      </Tabs>
    </div>
